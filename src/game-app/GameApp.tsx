...
export default function App() {
  ...
  // Combat: handleShoot + reload extracted to systems/combat.ts
  const combatDeps: any = {
    gameStateRef, isReloadingRef, ammoRef, lastShotTime,
    player, enemies, mapData, particles, pickups, graveyard, tracers, nextTracerId,
    decals, nextDecalId, recoilOffset, screenShake, objectiveRef, reloadTimeoutRef,
    nextKillfeedId,
    ...
    setIsReloading, setWeaponMags,
    checkLineOfSight, spawnParticles: (x: number, y: number, t: any) => spawnParticles(x, y, t),
  };
