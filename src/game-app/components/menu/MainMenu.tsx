...
const SbpButton: React.FC<{
  ...
  >
    ...
    <div className="absolute top-1 right-2 font-mono text-[8px] tracking-[0.3em] text-cyan-400/30 group-hover:text-cyan-300/70 transition-colors">
      ›
    </div>
...
const OpRow: React.FC<{
  label: string;
  value: string;
  tone: "cyan" | "amber" | "white" | "emerald" | "red";
}> = ({ label, value, tone }) => {
  ...
  return (
    <div className="flex items-baseline justify-between gap-4 border-b border-cyan-500/10 pb-1.5">
      ...
      <span className={`font-black text-xs md:text-sm tracking-wider ${colors[tone]} text-right`}>
        {value}
      </span>
    </div>
  );
                ...
                >
                  ...
                  <div className="mt-5 flex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-1 font-mono text-[10px] uppercase tracking-[0.3em] text-white/45 pl-4 border-l border-cyan-500/20">
                      <span>
                        Operation Status: <span className="text-amber-300/90">Breach Active</span>
                      </span>
                      <span>
                        Sector: <span className="text-cyan-300/90">Containment-05</span>
                      </span>
                    </div>
                  </div>
                </motion.div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 pl-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-[10px] font-mono tracking-[0.35em] text-cyan-300/90 uppercase">
                          Engage Hostile Sector
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col justify-between gap-2">
                      ...
                      <div className="space-y-1 font-mono text-[10px]">
                        <div className="flex justify-between">
                          <span className="text-white/40 uppercase tracking-wider">Armor</span>
                          <span className="text-cyan-300">Sapphire Plate</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-white/40 uppercase tracking-wider">Core</span>
                          <span className="text-emerald-300">Emerald Reactor</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-white/40 uppercase tracking-wider">Threat</span>
              ...
              <div className="p-8 md:p-10 bg-slate-950/50 border-b border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-blue-500/60 text-xs font-black uppercase tracking-[0.3em] mt-2 block">
                      Available Ordnance Control
                    </span>
                  </div>
                </div>
                <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {(["pistol", "rifle", "shotgun", "sniper"] as WeaponType[]).map((wKey) => {
                    ...
                    return (
                      <div
                        key={wKey}
                        className="group relative bg-white/5 backdrop-blur-md p-8 rounded-[2rem] border border-white/5 hover:border-white/20 transition-all overflow-hidden flex flex-col gap-6"
                      >
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-black/40 rounded-xl flex items-center justify-center border border-white/10 group-hover:border-blue-500/30">
                              <Swords
                                size={20}
                                className="text-blue-500/50 group-hover:text-blue-500"
                              />
                            </div>
                            <div>
                              <span className="text-[10px] text-blue-400 font-black uppercase tracking-widest block leading-none mb-1">
                                Class: {weapon.type.toUpperCase()}
                              </span>
                          ...
                          <div className="flex flex-col items-end">
                            ...
                            <span className="px-3 py-1 bg-blue-500/20 rounded-full text-blue-400 font-black text-xs tabular-nums border border-blue-500/20">
                        ...
                        <div className="grid grid-cols-2 gap-x-12 gap-y-5">
                          <div className="space-y-2">
                            <div className="flex justify-between text-[9px] font-black uppercase text-slate-500 tracking-tighter">
                              ...
                              <span className="text-white">
                                {Math.round(weapon.damage * (1 + upgrades.damage * 0.05))} TPU
                              </span>
                            </div>
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between text-[9px] font-black uppercase text-slate-500 tracking-tighter">
                              ...
                              <span className="text-white">
                                {Math.round(1000 / weapon.fireRate)} R/S
                              </span>
                            </div>
                            <div className="h-1.5 bg-black/40 rounded-full overflow-hidden">
                              <div
                                className="h-full bg-yellow-500 shadow-[0_0_8px_rgba(234,179,8,0.5)]"
                                style={{ width: `${(100 / weapon.fireRate) * 10}%` }}
                              />
                            </div>
                          </div>
                          <div className="space-y-2">
                            ...
                            <div className="h-1.5 bg-black/40 rounded-full overflow-hidden">
                              <div
                                ...
                                style={{ width: `${(weapon.magSize / 50) * 100}%` }}
                              />
                            </div>
                          </div>
                          <div className="space-y-2">
                            ...
                            <div className="h-1.5 bg-black/40 rounded-full overflow-hidden">
                              <div
                                ...
                                style={{ width: `${(weapon.range / 1500) * 100}%` }}
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                          <div className="text-[10px] text-slate-500 uppercase font-black tracking-tight flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-1.5 h-1.5 rounded-full ${weapon.isAuto ? "bg-cyan-500" : "bg-slate-700"}`}
                              />
                              <span>
                                {weapon.isAuto ? "Automatic Trigger Group" : "Precision Semi-Auto"}
                              </span>
                            </div>
                            {weapon.isScoped && (
          ...
          >
            <div className="bg-slate-900/90 backdrop-blur-2xl rounded-[3rem] border border-white/10 shadow-2xl p-10 md:p-16 w-full relative overflow-hidden">
              ...
              <div className="flex flex-col items-center mb-12">
                ...
                <h2 className="text-5xl md:text-6xl font-black text-white italic uppercase tracking-tighter text-center leading-none">
                  Mission Protocol
                </h2>
                <p className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.4em] mt-4 text-center max-w-sm">
                  Authority override required. Select deployment threat level.
                </p>
              </div>
                  ...
                  >
                    <div className="flex justify-between items-start mb-6 relative z-10">
                      <div className="flex flex-col">
                        ...
                        <span className="font-black uppercase text-3xl italic tracking-tighter leading-none">
                          {key}
                        </span>
                      </div>
                      <div
                        className={`w-4 h-4 rounded-full ${difficulty === key ? "bg-slate-900 animate-pulse" : ""}`}
                        style={{
                          backgroundColor: difficulty !== key ? DIFFICULTIES[key].color : undefined,
                        }}
                      />
                    </div>
                    ...
                    <div className="space-y-3 relative z-10">
                      <div className="flex justify-between items-center text-[11px]">
                        <span className="font-bold uppercase opacity-50 tracking-tight text-[10px]">
                          Resource Density
                        </span>
                        <span className="font-black tabular-nums">
                          {DIFFICULTIES[key].hpMult}X CAP
                        </span>
                      </div>
                      <div className="flex justify-between items-center text-[11px]">
                        <span className="font-bold uppercase opacity-50 tracking-tight text-[10px]">
                        ...
                        <span className="font-black tabular-nums">
                          {DIFFICULTIES[key].dmgMult}X DMG
                        </span>
                      </div>
                      <div
                        className={`flex justify-between items-center text-xs mt-4 pt-4 border-t ${difficulty === key ? "border-slate-950/10 text-slate-700" : "border-white/10 text-yellow-500"}`}
                      >
                        <span className="font-black uppercase tracking-tighter italic">
                          Credit Multiplier
                        </span>
                        <span className="font-black tabular-nums">
                          +{Math.round((DIFFICULTIES[key].creditMult - 1) * 100)}%
                        </span>
                      </div>
                    </div>
            ...
            <div className="bg-slate-900/90 backdrop-blur-2xl rounded-[3rem] border border-white/10 shadow-2xl p-8 md:p-16 w-full relative overflow-hidden flex flex-col">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
                <div className="bg-white/5 p-8 rounded-3xl border border-white/5 flex flex-col gap-2 group hover:border-white/20 transition-colors">
                  ...
                  <div className="text-4xl md:text-5xl font-black text-white tracking-tighter tabular-nums drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-black/40 p-8 rounded-[2.5rem] border border-white/10 flex flex-col gap-6">
                  <div className="flex justify-between items-center">
                    <h3 className="text-xs font-black text-white uppercase tracking-[0.4em] italic">
                      Sector Mastery
                    </h3>
                    <span className="text-[10px] text-cyan-400 font-bold uppercase">
                      Peak WAVE {lifetimeStats.bestWave}
                    </span>
                  </div>
                  <div className="flex gap-3 h-12">
                    {[1, 2, 3, 4, 5, 6].map((w) => (
                      <div key={w} className="flex-1 relative group">
                        <div
                          className={`absolute inset-0 rounded-xl transition-all duration-500 ${w <= lifetimeStats.bestWave ? "bg-cyan-500 shadow-[0_0_15px_rgba(34,211,238,0.5)]" : "bg-white/5"}`}
                        />
                        {w <= lifetimeStats.bestWave && (
                          <div className="absolute inset-0 bg-white/20 rounded-xl animate-pulse" />
                        )}
                        <span
                          className={`absolute inset-0 flex items-center justify-center text-[10px] font-black ${w <= lifetimeStats.bestWave ? "text-slate-950" : "text-white/20"}`}
                        >
                          {w}
                        </span>
                      </div>
                ...
                <div className="bg-black/40 p-8 rounded-[2.5rem] border border-white/10 flex flex-col justify-between">
                  <div>
                    <h3 className="text-xs font-black text-white uppercase tracking-[0.4em] italic mb-6">
                      Preferred Protocol
                    </h3>
                    <div className="flex items-center gap-6">
                      <div
                        className="w-16 h-16 rounded-3xl flex items-center justify-center border-4 border-white/10 group overflow-hidden relative shadow-2xl"
                        style={{ backgroundColor: DIFFICULTIES[difficulty].color }}
                      >
                        <div className="absolute inset-0 bg-white/20 mix-blend-overlay" />
                        <Shield size={32} className="text-white relative z-10" />
                      </div>
                      <div className="text-left">
                        <span className="text-white font-black text-3xl italic tracking-tighter uppercase leading-none">
                          {difficulty}
                        </span>
              ...
              <div className="p-8 md:p-10 bg-slate-950/50 border-b border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-6">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-cyan-500/60 text-xs font-black uppercase tracking-[0.3em] mt-2 block">
                      ...
                      >
                        ...
                        <div className="relative z-10 flex flex-col gap-4">
                          <div className="flex items-center justify-between">
                            <span
                              className={`text-[9px] font-black uppercase tracking-[0.3em] ${acc.text}`}
                            >
                          ...
                          <div className="aspect-square w-full rounded-xl overflow-hidden border border-white/10 bg-black/60 relative">
                            ...
                            <div className="absolute bottom-2 right-2 w-12 h-12 rounded-md border border-white/20 bg-black/70 backdrop-blur-sm p-0.5">
                              <div
                                ...
                                style={{
                                  gridTemplateColumns: `repeat(${a.mapData[0].length}, 1fr)`,
                                  gridTemplateRows: `repeat(${a.mapData.length}, 1fr)`,
                                }}
                              >
                                {a.mapData.flatMap((row, ry) =>
                                  row.map((cell, cx) => (
                                    <div
                                      key={`${a.id}-${ry}-${cx}`}
                                      className={
