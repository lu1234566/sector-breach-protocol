...
const PRESETS: Record<'low' | 'medium' | 'high', QualityPreset> = {
  low: { tier: 'low', pixelRatio: 1, shadows: false, bloom: false, propsDensity: 0.5, anisotropy: 1, maxLights: 4 },
  medium: { tier: 'medium', pixelRatio: 1, shadows: 'basic', bloom: false, propsDensity: 1, anisotropy: 4, maxLights: 8 },
  high: { tier: 'high', pixelRatio: Math.min(2, typeof window !== 'undefined' ? window.devicePixelRatio : 1), shadows: 'pcfsoft', bloom: true, propsDensity: 1, anisotropy: 8, maxLights: 16 },
};
